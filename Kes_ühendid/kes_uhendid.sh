...
paste -d ' ' read1.txt read2.txt | grep 'lemma="kes"' \
> $myOutput
echo completed
...
# osaks on sõna 'kes' (kusjuures selle skripti tulemusena võib 'kes' olla nii
...
# tühik ja jätab alles ainult need read, kus üheks sõnapaari osaks on 'kes'
